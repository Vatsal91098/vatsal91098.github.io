...
(function($){
    ...
    if($("#googlemap").length > 0){
        ...
        var myOptions = {
            ...
            zoom: 15,
            center: new google.maps.LatLng(23.059784, 72.562811), //change the coordinates
        ...
        var marker = new google.maps.Marker({
                ...
                map: map,
                position: new google.maps.LatLng(23.059784, 72.562811)  //change the coordinates
            
        });

        var infowindow = new google.maps.InfoWindow({
            
                content: "<div style='color:#222'><b>Vatsal Chauhan</b><br/>A-404, Govind Plaza, Kiranpark, Nava Wadaj, Ahmedabad-38013<br/> Kerjo</div>"  //change your address
